$(document).ready(function () {
    var apiKey = "qpITfjfSKmdoaPG9yCPW4NuxquYNTBKk";
    var buttonClass = ".button-landing";
    var imageRowID = "#image-row";
    var arrDefaultButtons = ["Iron Man", "Captain America", "Superman", "Dance", "Tigers", "Cheetah", "Tron Legacy", "EDC", "Tiesto", "Disney", "Dragon Ball Z"];
    var maxImg = 10;
